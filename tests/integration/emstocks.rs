use eaglemode_rs::emCore::emRec::{parse_rec_with_format, write_rec_with_format};
use eaglemode_rs::emCore::emRecRecord::Record;
use eaglemode_rs::emStocks::emStocksConfig::{emStocksConfig, ChartPeriod, Sorting};
use eaglemode_rs::emStocks::emStocksListBox::emStocksListBox;
use eaglemode_rs::emStocks::emStocksRec::{emStocksRec, Interest, StockRec};
