...
/// Allocator closure for a dynamic child record.
///
/// C++ reference: `emRec.h` type `emRecAllocator` — a function pointer
/// `emRec* (*)()` used by `emUnionRec` (one per variant) and `emArrayRec`
...
/// 2026-04-21-phase-4b-listener-tree-adr.md for the reified-chain rep that
/// makes this parameter necessary.
