...
| Known Rust-port incompletenesses remaining | W3 surface de-dup (SP6, optional), `emContext` threading (SP7, ARCH). SP1, SP2, SP3, SP4, SP4.5, SP5, and SP8 all closed (SP1–SP5 on 2026-04-18; SP4.5 and SP8 on 2026-04-19). |
...
**Suggested execution order:** ~~SP1~~ → ~~SP3~~ → ~~SP4~~ → ~~SP5~~ → ~~SP4.5~~ → ~~SP8~~ → SP6 if wanted → SP7 when the motivation arrives. (SP2 turned out to be already done — landed in SP1 as W1b.) SP1, SP3, SP4, and SP5 landed 2026-04-18; SP4.5 and SP8 landed 2026-04-19.
